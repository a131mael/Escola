...
//	private Logger log;
	 ...
	 * editarrAlunos(inicio, quantidade, anoLetivoAtual); // alterarConfiguracao();
	 * // mudarDataDosEventos(); }
	 */

//	public void finalizarAnoLetivo(int inicio, int quantidade, int anoLetivoAtual, Serie serie) {
//		editarrAlunos( inicio, quantidade, anoLetivoAtual, serie);
//		// alterarConfiguracao();
//		// mudarDataDosEventos();
//	}
	...
	public void mudarDataDosEventos() {
		...
		for (Evento evento : todosEventos) {
			...
			evento.setDataInicio(
					mudarAno(evento.getDataInicio(), configuracaoService.getConfiguracao().getAnoLetivo()));
			em.persist(evento);
		}
	}
...
//	}
	...
	public synchronized void gerarHistorico(Aluno aluno, int ano, boolean mesmoano) {
		gerarHistorico(aluno, ano, mesmoano, null);
	}

	public synchronized void gerarHistorico(Aluno aluno, int ano, boolean mesmoano, Serie serie) {
...
//				gerarHistorico(alunos.get(i), anoLetivoAtual);
...
//	//	editarrAlunos(alunos, inicio, quantidade, anoLetivoAtual, null);
//	}

//	public void editarrAlunos(int inicio, int quantidade, int anoLetivoAtual, Serie serie) {
//		System.out.println("Iniciando a serie : " + serie.getName());
//		
//		List<Aluno> alunos = configuracaoService.findAlunosAlunoLetivo(anoLetivoAtual, serie);
//		
//		for (int i = inicio; i < alunos.size(); i++) {
//			try {
...
//
//				try {
//					alunoService.saveSerie(alunos.get(i));
//				} catch (Exception e) {
//				}
//
//				em.clear();
...
//	}
	...
	public synchronized void gerarHistorico(int inicio, int quantidade, short ano) {
		List<Aluno> alunos = alunoService.findAlunoDoAno(ano);
